  ...
  return (
    <div {...props} className={cn(props.className, "group")}>
      ...
      <div className="inline-flex absolute top-3 left-0 h-5 z-50 opacity-0 group-hover:opacity-100">
        <Button
          variant="secondary"
          className="size-5 drag-handle bg-background/80 backdrop-blur-sm "
        >
      ...
      <div className="inline-flex absolute top-3 right-0 z-50 opacity-0 group-hover:opacity-100 gap-2">
        <GroupSelector />
        <Button
          variant="secondary"
          size="icon"
          className="p-0 size-5 bg-background/80 backdrop-blur-sm"
